...
const faqJsonLd = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Cosa puÃ² fare un veterinario con UNIMALIA?",
      acceptedAnswer: {
        "@type": "Answer",
        text:
          "PuÃ² gestire la cartella sanitaria digitale, aggiungere eventi clinici, aggiornare i dati essenziali, inviare referti al proprietario, scambiarsi consulti con altri veterinari della Rete e lavorare sui pazienti attivi con grant valido.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text:
          "I veterinari della Rete UNIMALIA possono scambiarsi consulti tramite una sezione dedicata, con logica simile a una inbox email: invii, risposte, archivio e condivisione rapida dello storico dellâ€™animale.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text:
          "SÃ¬. Quando il veterinario utilizza questo canale, il proprietario riceve il referto via email. Se ha Premium, puÃ² anche vedere la timeline completa e organizzata allâ€™interno della piattaforma.",
      },
    },
  ],
};
      ...
      <div className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        ...
        <header className="mt-6 rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-sm sm:p-10">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-zinc-600">
            UNIMALIA offre ai veterinari uno spazio digitale per lavorare in modo piÃ¹ ordinato,
            ...
            strumenti per una gestione piÃ¹ moderna della clinica.
          </p>
        ...
        <div className="mt-8 grid gap-6">
          <Section title="Cartella sanitaria digitale">
            <p>
              ...
              raccogliere in modo piÃ¹ ordinato le informazioni utili dellâ€™animale.
            </p>
            <p>
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>aggiunge lâ€™evento</li>
              <li>aggiorna la cartella sanitaria dellâ€™animale</li>
              <li>invia al proprietario quanto fatto, con eventuale referto via email</li>
            </ul>
          </Section>

          <Section title="La funzione piÃ¹ importante: consulti veterinari tra colleghi">
            <p>
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>condivisione rapida dello storico dellâ€™animale con un click</li>
            </ul>
            <p>
              In questo modo il confronto tra colleghi diventa piÃ¹ ordinato, piÃ¹ tracciabile e
              piÃ¹ utile nei casi in cui serve continuitÃ  clinica.
            </p>
          </Section>
          ...
          <Section title="Referti e rapporto con il proprietario">
            ...
            <p>
              Per i proprietari Premium, oltre alla mail, la documentazione puÃ² essere consultata
              anche in una timeline completa e organizzata allâ€™interno della piattaforma.
            </p>
          </Section>

          <Section title="Remind e follow-up">
            <p>
              I veterinari possono impostare remind per controlli, vaccini o altre necessitÃ 
              cliniche.
            </p>
            <p>
          ...
          <Section title="Accesso ai pazienti anche fuori dalla clinica">
            <p>
              ...
              esempio quando si Ã¨ reperibili.
            </p>
            <p>
              Questo vale nei limiti del <strong>grant attivo</strong>, quindi solo quando esiste
              unâ€™autorizzazione valida da parte del proprietario.
            </p>
          </Section>

          <Section title="Pazienti attivi e concessioni">
            <p>
              La clinica puÃ² avere una visione piÃ¹ chiara dei propri pazienti attivi e distinguere
              tra:
            </p>
            <ul className="list-disc space-y-2 pl-6">
          ...
          <Section title="Ricerca per zona e competenze reali">
            <p>
              Allâ€™interno del sito Ã¨ presente anche una sezione di ricerca che permette ai
              veterinari di essere trovati per zona e per competenze reali.
            </p>
            <p>
              Questo puÃ² essere utile sia per visite specialistiche sia per essere trovati piÃ¹
              facilmente dai proprietari anche allâ€™interno della piattaforma.
            </p>
          </Section>

          <Section title="Agenda intelligente in evoluzione">
            <p>
              Ãˆ in costruzione, ed Ã¨ giÃ  stata implementata in parte, una futura agenda
              intelligente pensata per supportare anche le prenotazioni online.
            </p>
            <p>
              Lâ€™obiettivo Ã¨ integrare meglio il lavoro clinico, lâ€™organizzazione interna e il
          ...
          <Section title="PerchÃ© entrare nella Rete UNIMALIA">
            <ul className="list-disc space-y-2 pl-6">
              <li>lavori su una cartella sanitaria digitale piÃ¹ ordinata</li>
          ...
          <Section title="Richiedi informazioni">
            <p>
              ...
              per la tua clinica o per la tua attivitÃ  veterinaria, puoi contattarci qui:
            </p>
