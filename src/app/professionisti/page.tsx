          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
            <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-600">
                  Area preparata per il nuovo flusso REV personale del veterinario. Il collegamento
                  reale SPID/CAS verrà attivato appena saranno confermati i dati definitivi.
                </p>
              </div>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-xl bg-black px-5 py-3 text-sm font-semibold text-white hover:bg-zinc-800"
              >
