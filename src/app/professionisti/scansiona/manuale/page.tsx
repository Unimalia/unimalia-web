export default async function ScansionaManualePage({
  searchParams,
}: {
    ...
    <div className="space-y-6">
      <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-zinc-600">
          ...
          (ricerca, associazione, creazione scheda, ecc.).
        </p>
      </div>
      ...
      <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 text-sm text-zinc-600">
          TODO: definire azione (es. cerca animale, crea richiesta, apri form, ecc.)
        </div>
      </div>
    </div>
  );
